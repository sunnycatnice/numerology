...
path_dict_copy = "./dictionaries/output/eng_dict_copy.txt"
# path definitions for configs
path_name_compatibility = "./config/name_compatibility.conf"
...
# path definitions for output file
path_output_file = "./output/output.txt"